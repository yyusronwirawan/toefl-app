					...
					<ul>
                        ...
                        <li>
                            <Link href="/admin/students">
                               <i class="bx bx-right-arrow-alt"></i>Calon Peserta
					        </Link>
                        </li>
					</ul>
				</li>
					...
					<ul>
						<li>
                            <Link href="/admin/exams">
                               <i class="bx bx-right-arrow-alt"></i>Ujian
					        </Link>
                        </li>
						<li> <a href="#"><i class="bx bx-right-arrow-alt"></i>Grup Ujian</a></li>
						<li> <a href="#"><i class="bx bx-right-arrow-alt"></i>Sesi Ujian</a></li>
					</ul>
				</li>
            ...
            <ul class="metismenu" id="menu" v-if="$page.props.auth.user.level == 2">
                ...
                <li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">Try Out Gabungan</div>
					</a>
					<ul>
						<li>
