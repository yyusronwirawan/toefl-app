            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto">
                            <Link href="/admin/users/create" class="btn btn-primary btn-sm btn-sm mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i> Tambah User</Link>
                        </div>
                    </div>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr v-for="(user, index) in users.data" :key="index">
                                    ...
                                    <td><span class="badge bg-success">{{ user.level == 1 ? 'Admin' : 'Peserta' }}</span></td>
                                    <td align="">
                                        <div class="btn-group">
