<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Edit Ujian</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="number" class="form-control" v-model="form.price" :class="{ 'is-invalid': errors.price }" placeholder="Nama">
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                ...
                template_id: props.exam.template_id,
                ...
                duration_type: props.exam.duration_type,
                duration_section: props.duration_section,
                button_type_finish: props.exam.button_type_finish,
                repeat_the_exam: props.exam.repeat_the_exam,
                print_certificate: props.exam.print_certificate,
                valid_until: props.exam.valid_until,
                show_ranking: props.exam.show_ranking,
                exam_start_time: props.exam.exam_start_time,
                exam_end_time: props.exam.exam_end_time,
