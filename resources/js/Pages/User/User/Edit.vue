                ...
                <div class="card border-top border-0 border-3 border-primary">
                    ...
                    <div class="card-body">
                        <div class="d-lg-flex align-items-center">
                            ...
                            <div class="ms-auto">
                                <Link href="/user/users" class="btn btn-primary btn-sm btn-sm mt-2 mt-lg-0">Kembali</Link>
                            </div>
                        </div>
                        <hr/>
                        <div class="row g-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <input type="date" v-model="form.date_of_birth" :class="{ 'is-invalid': errors.date_of_birth }" class="form-control" placeholder="Tanggal Lahir">
    ...
    export default {
        ...
        setup(props) {         
            const form = reactive({
                ...
                date_of_birth: props.user.student && props.user.student.date_of_birth ? props.user.student.date_of_birth : '',
