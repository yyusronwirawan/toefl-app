<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Aktivasi</title>
    </Head>
                                ...
                                <form @submit.prevent="submit" class="row g-3">
                                    <div class="p-5">
                                        ...
                                        <div class="d-grid gap-2">
                                            <br>
                                            <Link :href="`/user/${user.id}/activation/actived`" class="btn btn-primary btn-sm">Klik Untuk Mengaktifkan Akun</Link>
                                        </div>
                                    </div>
                                </form>
                            </div>
